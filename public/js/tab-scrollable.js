...
var scrollTab = function($) {
    ...
    var Template = {
        ...
        SCROLL_LEFT: "<div class='scroll-tabs-scroll-left'><i class='fa fa-caret-left fa-lg'></i></div>",
        SCROLL_RIGHT: "<div class='scroll-tabs-scroll-right'><i class='fa fa-caret-right fa-lg'></i></div>",
